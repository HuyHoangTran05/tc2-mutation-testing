...
- Started: 2026-09-17T15:11:17, duration 119.0 s, exit code 0

## Scores

- Mutation score (killed + timeout) / valid: 354/359 = 98.6%
- Score on covered code (excludes NoCoverage): 354/359 = 98.6%
- Excluding reviewed equivalents (4): 354/355 = 99.7%
...
| `packages/dinero.js/src/core/api/allocate.ts` | 26 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `packages/dinero.js/src/core/api/haveSameAmount.ts` | 4 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `packages/dinero.js/src/core/utils/distribute.ts` | 22 | 1 | 0 | 3 | 0 | 0 | 0 |
